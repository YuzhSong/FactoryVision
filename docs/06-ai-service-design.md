...
| `person_detector` | `modules/person_detector.py` | 基于 YOLO 检测人员位置 | placeholder |
| `face_recognition_service` | `modules/face_recognition_service.py` | 加载人脸库并识别人脸身份 | placeholder |
| `helmet_detector` | `modules/helmet_detector.py` | 检测头盔佩戴状态 | placeholder |
| `zone_detector` | `modules/zone_detector.py` | 判断人员是否进入警戒区域 | placeholder |
| `fall_detector` | `modules/fall_detector.py` | 判断人员摔倒风险 | placeholder |
| `running_detector` | `modules/running_detector.py` | 判断异常跑动行为 | placeholder |
| `event_sender` | `modules/event_sender.py` | 将检测结果上报到后端 API | placeholder |
