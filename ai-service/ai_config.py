...
class Config:
    ...
    FACE_LIVENESS_ENABLED = os.getenv("FACE_LIVENESS_ENABLED", "True").lower() == "true"
    FACE_LIVENESS_THRESHOLD = float(os.getenv("FACE_LIVENESS_THRESHOLD", "0.55"))
    FACE_LIVENESS_MIN_FACE_SIZE = int(os.getenv("FACE_LIVENESS_MIN_FACE_SIZE", "48"))
    FACE_LIVENESS_MODEL_PATH = os.getenv("FACE_LIVENESS_MODEL_PATH", "")
    FACE_LIVENESS_REQUIRE_FOR_ENROLLMENT = os.getenv("FACE_LIVENESS_REQUIRE_FOR_ENROLLMENT", "False").lower() == "true"
