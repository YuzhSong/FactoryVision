...
class Config:
    ...
    STREAM_MAX_FRAME_AGE_MS = float(os.getenv("STREAM_MAX_FRAME_AGE_MS", "1500"))
    ...
    STREAM_INCLUDE_HELMET_DEFAULT = os.getenv("STREAM_INCLUDE_HELMET_DEFAULT", "True").lower() == "true"
    STREAM_INCLUDE_FALL_DEFAULT = os.getenv("STREAM_INCLUDE_FALL_DEFAULT", "True").lower() == "true"
    STREAM_INCLUDE_ZONE_DEFAULT = os.getenv("STREAM_INCLUDE_ZONE_DEFAULT", "True").lower() == "true"
    ...
    FALL_MIN_CONFIDENCE = float(os.getenv("FALL_MIN_CONFIDENCE", "0.55"))
    ...
    FALL_MIN_CENTER_DROP_RATIO = float(os.getenv("FALL_MIN_CENTER_DROP_RATIO", "0.10"))
    FALL_MIN_HEIGHT_DROP_RATIO = float(os.getenv("FALL_MIN_HEIGHT_DROP_RATIO", "0.15"))
    FALL_MAX_TRANSITION_SECONDS = float(os.getenv("FALL_MAX_TRANSITION_SECONDS", "3.0"))
