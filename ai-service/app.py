...
frame_processor = FrameProcessor(
    ...
    abnormal_config={
        ...
        "fallSustainedLowDropRatio": Config.FALL_SUSTAINED_LOW_DROP_RATIO,
        "fallLowPostureHeightRatio": Config.FALL_LOW_POSTURE_HEIGHT_RATIO,
        "fallVeryLowHeightRatio": Config.FALL_VERY_LOW_HEIGHT_RATIO,
        "fallSlowTransitionSeconds": Config.FALL_SLOW_TRANSITION_SECONDS,
