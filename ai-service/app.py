...
face_service = FaceRecognitionService(
    ...
    liveness_enabled=Config.FACE_LIVENESS_ENABLED,
    liveness_threshold=Config.FACE_LIVENESS_THRESHOLD,
    liveness_min_face_size=Config.FACE_LIVENESS_MIN_FACE_SIZE,
    liveness_model_path=Config.FACE_LIVENESS_MODEL_PATH or None,
    liveness_require_for_enrollment=Config.FACE_LIVENESS_REQUIRE_FOR_ENROLLMENT,
